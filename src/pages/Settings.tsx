    ...
    <div className="flex h-screen w-full">
      ...
      <div className="flex flex-col gap-10 p-10 border-r-5">
        ...
        <div className="flex flex-col gap-3 font-semibold text-xl w-full">
          ...
          <h1 onClick={() => setSection("parametri")} className={`${section == "parametri" ? "text-black" : "text-gray-500"} flex align-middle items-center gap-1`}><FaDatabase/>Parametri</h1>
        </div>
      </div> 
      ...
      {section == "parametri" && (
        <div className="p-10 flex flex-col gap-3 w-full">
          ...
          {paramsLoading && <div className="text-gray-500">Caricamento parametri…</div>}
          {paramsError && <div className="text-red-500">Impossibile caricare i parametri.</div>}

          {!paramsLoading && !paramsError && (
            <>
              <form onSubmit={handleUpdateMaxTime} className="flex flex-col w-full gap-2 ">
                ...
                <div className="flex gap-2">
                    ...
                    />
                    <button type="submit" className="px-4 bg-blue-500 rounded-xl flex justify-center items-center leading-none gap-3 align-middle text-white font-semibold">
                    <MdUpdate/> Aggiorna
                    </button>
                </div> 
              </form>
