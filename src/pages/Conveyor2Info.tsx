...
const Conveyor2Info = () => {
  ...
  const errors: ErrorItem[] = useMemo(() => {
    return errorsData
      ...
      .sort((a, b) => {
        ...
        return String(b.id).localeCompare(String(a.id)); // tie-breaker stabile
      })
      .map((e) => {
  ...
  const hasM3 = useMemo(
    () => errorsData.some((e) => e?.unita_misurata === "M3"),
    [errorsData]
  );
    ...
    >
      <div className="absolute inset-0 z-[100] pointer-events-none p-10 flex">
        <div className="space-y-3">
          ...
          <h1 className="text-5xl font-extrabold tracking-tight">RULLO 2</h1>
